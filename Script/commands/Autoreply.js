...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস 𝚂𝙷𝙰𝙼𝙸𝙼 রে হাঙ্গা করো😶👻😘",
    "kiss de": "কিস দিস না তোর মুখে দূর গন্ধ কয়দিন ধরে দাঁত ব্রাশ করিস নাই🤬",
    "👍": "লাইক না দিয়ে বস 𝚂𝙷𝙰𝙼𝙸𝙼 কে একটা গার্লফ্রেন্ড দে..!🐸🤣👍⛏️",
    "help": "Prefix de sala",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Shamim Islam☜\nFacebook: https://www.facebook.com/profile.php?id=100009018396023\nWhatsApp: +8801827404801",
    "admin": "He is  𝚂𝙷𝙰𝙼𝙸𝙼 তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস 𝚂𝙷𝙰𝙼𝙸𝙼 রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস 𝚂𝙷𝙰𝙼𝙸𝙼 এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss 𝚂𝙷𝙰𝙼𝙸𝙼 এর ইনবক্সে গুতা দিন 😘",
